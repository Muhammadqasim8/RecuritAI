...
// const TECHNOLOGIES = [
//   { id: 1, name: 'ReactJS', icon: 'react', color: 'blue' },
//   { id: 2, name: 'Node.js', icon: 'node', color: 'green' },
//   { id: 3, name: 'Flutter', icon: 'flutter', color: 'cyan' },
//   { id: 4, name: 'Logical', icon: 'brain', color: 'purple' }
// ];
...
//               <div>
//                 <p className="text-gray-500 text-sm">Total Tests</p>
//                 <p className="text-2xl font-bold text-gray-800">{dashboardStats.totalTests}</p>
//               </div>
//               <div className="bg-indigo-100 p-3 rounded-full">
//                 <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
...
//               <div>
//                 <p className="text-gray-500 text-sm">Technologies</p>
//                 <p className="text-2xl font-bold text-gray-800">{dashboardStats.totalTechnologies}</p>
//               </div>
//               <div className="bg-amber-100 p-3 rounded-full">
//                 <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
...
//               <div>
//                 <p className="text-gray-500 text-sm">Active Assessments</p>
//                 <p className="text-2xl font-bold text-gray-800">{dashboardStats.activeAssessments}</p>
//               </div>
//               <div className="bg-rose-100 p-3 rounded-full">
//                 <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-rose-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
...
//                 <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
//               </svg>
//               <p className="text-indigo-600 text-lg font-medium">Loading dashboard data...</p>
//             </div>
//           </div>
//         )}
...
//         {activeTab === 'technologies' && !loading && !error && (
//           <div className="space-y-8">
...
//                   key={tech.id} 
//                   technology={tech}
//                   onClick={() => navigate(`/admin/technology/${tech.id}`)}
//                 />
//               ))}
//             </div>
//           </div>
