      ...
      <div className="flex w-full max-w-6xl flex-col justify-between gap-4 py-8 sm:flex-row">
        <div className="flex flex-col gap-2">
          ...
          <div className="max-w-[320px] text-sm ">
            RecruitAI is an advanced AI-powered tool that helps recruiters 
            efficiently screen candidates, detect fake job postings, and match 
        ...
        <div className="flex flex-col items-start justify-start gap-4 sm:flex-row sm:items-center">
          ...
          <a
            className="flex items-center justify-center whitespace-nowrap font-normal ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border hover:text-black border-input bg-background hover:bg-white h-10 md:h-8 text-xs px-3 rounded-full"
            href=""
          >
            Get Started
          </a>
